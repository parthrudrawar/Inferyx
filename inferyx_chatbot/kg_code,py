...
Return the output as structured graph JSON with "nodes" and "relationships". Be as accurate and logical as possible.
...
# -----------------------
transformer = LLMGraphTransformer(llm=llm, prompt=custom_prompt)
